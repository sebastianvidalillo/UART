...
HD_PWD='D:/Universidad/LAB_DIGITALES/Examples/ELO212-example-modules-master/uart_esclavo/uart_esclavo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log esclavo_endpoint_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source esclavo_endpoint_uart.tcl
